  ...
  return (
    <Container fluid className="d-flex p-0 min-vh-100">
      ...
      <main className="flex-grow-1 d-flex justify-content-center align-items-center px-3 py-4">
        <Card
          className="shadow-lg rounded-4 p-3 w-100"
          style={{ maxWidth: '500px' }} // Tamaño más pequeño y centrado
          onMouseEnter={e => (e.currentTarget.style.transform = 'scale(1.02)')}
          onMouseLeave={e => (e.currentTarget.style.transform = 'scale(1)')}
        >
          <h2 className="mb-3 text-center fw-bold display-6 text-primary">
            Perfil d'usuari
          </h2>

          <Row className="gy-3">
            <Col xs={12} md={6} className="border-md-end pe-md-3">
              <h5 className="mb-3 fw-semibold text-secondary border-bottom pb-2">Informació personal</h5>
              <p className="fs-6"><strong>Nom:</strong> {usuari.nom || 'N/D'}</p>
              <p className="fs-6"><strong>Email:</strong> {usuari.correu_electronic || 'N/D'}</p>
              <p className="fs-6"><strong>Edat:</strong> {usuari.edat || 'N/D'}</p>
            </Col>

            <Col xs={12} md={6} className="ps-md-3">
              <h5 className="mb-3 fw-semibold text-secondary border-bottom pb-2">Estadístiques</h5>
              <p className="fs-6"><strong>Total partits disputats:</strong> {partitsDisputatsCount}</p>
            </Col>
          </Row>
        </Card>
      </main>
